...
def test_add_company_last_xdays_sales(test_db):
    ...
    assert \
        df[
            ...
            (df['date'] == '2023-02-09')
        ][f'company_last_{days}days_sales'].values[0] == 40
    assert \
        df[
            (df['sku'] == '2') &
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2023-02-19')
        ][f'company_last_{days}days_sales'].values[0] == 0
    assert \
        df[
            (df['sku'] == '2') &
            (df['warehouse'] == 'MALLSPORT') &
...
def test_add_company_last_xdays_mean_sales(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-02-08')
        ][f'company_last_{days}days_mean_sales'
...
def test_add_company_historic_sales(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-03-15')
        ][f'company_historic_sales'].values[0] == 68
    assert \
        df[
            (df['sku'] == '2') &
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-02-23')
        ][f'company_historic_sales'].values[0] == 34
    assert \
        df[
            (df['sku'] == '2') &
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2023-08-09')
        ][f'company_historic_sales'].values[0] == 78
    assert \
        df[
            (df['sku'] == '4') &
            (df['warehouse'] == 'MALLSPORT') &
...
def test_add_company_historic_sales_same_day_of_the_week(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-02-08')
        ][f'company_historic_sales_same_day_of_the_week'].values[0] == 0
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'COSTANERA') &
            (df['date'] == '2023-02-15')
        ][f'company_historic_sales_same_day_of_the_week'].values[0] == 5
    assert \
        df[
            (df['sku'] == '2') &
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-02-09')
        ][f'company_historic_sales_same_day_of_the_week'].values[0] == 4
    assert \
        df[
            (df['sku'] == '4') &
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2023-02-17')
        ][f'company_historic_sales_same_day_of_the_week'].values[0] == 9
    assert \
        df[
            (df['sku'] == '4') &
            (df['warehouse'] == 'LADEHESA') &
            (df['date'] == '2023-02-10')
        ][f'company_historic_sales_same_day_of_the_week'].values[0] == 6
    assert \
        df[
            (df['sku'] == '4') &
            (df['warehouse'] == 'MALLSPORT') &
...
def test_add_company_historic_sales_same_month(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'COSTANERA') &
            (df['date'] == '2023-02-27')
        ]['company_historic_sales_same_month'].values[0] == 100
    assert \
        df[
            (df['sku'] == '2') &
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2022-12-09')
        ]['company_historic_sales_same_month'].values[0] == 50
    assert \
        df[
            (df['sku'] == '2') &
            (df['warehouse'] == 'PUCON') &
...
def test_add_company_cumulative_sales_in_the_week(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-02-06')
        ]['company_cumulative_sales_in_the_week'].values[0] == 0
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'LADEHESA') &
            (df['date'] == '2023-02-12')
        ]['company_cumulative_sales_in_the_week'].values[0] == 390
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'LADEHESA') &
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2023-02-08')
        ]['company_cumulative_sales_in_the_week'].values[0] == 200
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'MALLSPORT') &
...
def test_add_company_cumulative_sales_in_the_month(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'LADEHESA') &
            (df['date'] == '2023-02-27')
        ]['company_cumulative_sales_in_the_month'].values[0] == 200
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'LADEHESA') &
            (df['date'] == '2023-02-28')
        ]['company_cumulative_sales_in_the_month'].values[0] == 280
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'MALLSPORT') &
...
def test_add_company_cumulative_sales_in_the_year(test_db):
    ...
    assert \
        df[
            ...
            (df['warehouse'] == 'LASCONDES') &
            (df['date'] == '2023-02-12')
        ]['company_cumulative_sales_in_the_year'].values[0] == 0
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'LADEHESA') &
            (df['date'] == '2023-04-27')
        ]['company_cumulative_sales_in_the_year'].values[0] == 200
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'LADEHESA') &
            (df['date'] == '2023-05-28')
        ]['company_cumulative_sales_in_the_year'].values[0] == 280
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2023-11-09')
        ]['company_cumulative_sales_in_the_year'].values[0] == 330
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'MALLSPORT') &
            (df['date'] == '2018-12-09')
        ]['company_cumulative_sales_in_the_year'].values[0] == 100
    assert \
        df[
            (df['sku'] == '1') &
            (df['warehouse'] == 'LASCONDES') &
